...
markers_ = c("LDHA", "LDHB", "SLC16A1", "SLC16A3", "VCAM1", "GFAP", "TUBB3")
...
#ploM_$UKF242_C + ploM_$UKF242_T + ploM_$UKF265_C + plot_layout(guides="collect") &
...
ggsave(file="bigoV2.svg", plot=bigo, width=30, height=100, limitsize = FALSE )
